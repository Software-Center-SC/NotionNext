    ...
    <div
      ...
      <header className='group flex flex-col h-full justify-between'>
        ...
        <main className='flex flex-col flex-grow relative'>
          ...
          {/* LOGO SUPERPUESTO (Aumentado ligeramente: w-12 h-12 y mt-6 para centrado) */}
            ...
            <div className='flex justify-center -mt-6 relative z-10'>
              <SmartLink href={post?.href} passHref legacyBehavior>
                <div className='w-12 h-12 bg-white dark:bg-hexo-black-gray shadow-md rounded-xl cursor-pointer transition-transform duration-300 group-hover:-translate-y-1 border border-gray-100 dark:border-gray-800 relative overflow-hidden'>
                  ...
                  {/* Jaula de posicionamiento absoluto: logo aumentado a w-9 h-9 */}
                  <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-9 h-9 flex items-center justify-center [&_.notion-icon]:!m-0 [&_.notion-icon]:!block [&_.notion-icon]:!w-full [&_.notion-icon]:!h-full [&_img]:!m-0 [&_img]:!w-full [&_img]:!h-full [&_img]:!object-contain text-4xl leading-none'>
